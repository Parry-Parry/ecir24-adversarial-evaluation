...
def read_rerank(in_file : str = 't5-base-re-ranking/rerank-with-scores.jsonl.gz', out_file : str = 't5-base-re-ranking/highly-retrievable-terms.jsonl', agg : str = 'median'):
