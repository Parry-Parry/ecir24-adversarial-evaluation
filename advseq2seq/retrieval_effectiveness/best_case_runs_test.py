...
from .evaluation_utils import best_case_runs
...
class TestBestCaseRuns(unittest.TestCase):
    ...
    def test_best_case_runs_02_multiple_runs(self):
        qrels = pd.DataFrame(
            [{'qid': '1', 'docno': 'doc-1', 'label': 1},
             {'qid': '1', 'docno': 'doc-2', 'label': 0},
             {'qid': '1', 'docno': 'doc-3', 'label': 1},
        ...
        adversarial_rankings = [pd.DataFrame([
            ...
            {'qid': '1', 'docno': 'doc-2', 'score': 0.12},
            {'qid': '1', 'docno': 'doc-3', 'score': 0.13},
        ]), pd.DataFrame([
            {'qid': '1', 'docno': 'doc-1', 'score': 0.2},
            {'qid': '1', 'docno': 'doc-2', 'score': 0.22},
            {'qid': '1', 'docno': 'doc-3', 'score': 0.23},
        ])]
    ...
    def test_wost_case_runs_02_multiple_runs_02(self):
        qrels = pd.DataFrame(
            [{'qid': '1', 'docno': 'doc-1', 'label': 1},
             {'qid': '1', 'docno': 'doc-2', 'label': 0},
             {'qid': '1', 'docno': 'doc-3', 'label': 1},
        ...
        adversarial_rankings = [pd.DataFrame([
            ...
            {'qid': '1', 'docno': 'doc-1', 'score': 0.97},
            {'qid': '1', 'docno': 'doc-2', 'score': 0.99},
            {'qid': '1', 'docno': 'doc-3', 'score': 0.98},
        ])]
